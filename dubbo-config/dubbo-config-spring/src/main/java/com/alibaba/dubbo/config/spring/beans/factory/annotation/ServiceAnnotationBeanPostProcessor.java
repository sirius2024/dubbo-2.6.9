...
public class ServiceAnnotationBeanPostProcessor implements BeanDefinitionRegistryPostProcessor, EnvironmentAware,
     ...
     * 1、自定义ClassPathBeanDefinitionScanner
     * 2、对dubbo中的@Service扫描，把又@Service注解的类变成BeanDefinition
     * 3、循环之前扫描到的所有BeanDefinition，创建ServiceBean的BeanDefinition对象
     * 4、对serviceBean的BeanDefinition对象进行属性填充
     * 5、注册
     * @param packagesToScan The base packages to scan
     * @param registry       {@link BeanDefinitionRegistry}
     */
    private void registerServiceBeans(Set<String> packagesToScan, BeanDefinitionRegistry registry) {
        //扫描器继承ClassPathBeanDefinitionScanner
    ...
    private void registerServiceBean(BeanDefinitionHolder beanDefinitionHolder, BeanDefinitionRegistry registry,
        ...
        //ServiceBean需要暴露发布  @Service注解里面的属性  很多RegistryConfig等配置信息也要放入ServiceBean中后面发布
        //ServiceBean继承ServiceConfig
        //创建ServiceBean的beanDefinition对象  核心每一个@Service都创建一个ServiceBean的BeanDefinition对象
